...
6. In the command window, type `python pixel_art_extractor.py -h` and press enter to check everything is working.
...
10. You can also use the following optional parameters:
